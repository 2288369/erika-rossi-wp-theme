 ...
 */
 function erikarossi_theme_scripts() {
     wp_enqueue_style( 'erikarossi', get_stylesheet_uri() );
 }
 add_action( 'wp_enqueue_scripts', 'erikarossi_theme_scripts' );
 ...
 // END STEP 2.9
     ...
     function add_my_menus() {
        register_nav_menus(
        array(
            'header-menu' => __( 'Header Menu', 'erika-rossi' ),
            'footer-menu' => __( 'Footer Menu', 'erika-rossi' ),
            'social-menu' => __( 'Social Menu', 'erika-rossi'),
    ...
    function erikarossi_theme_init(){
        ...
        add_action('after_setup_theme', 'erikarossi_theme_init');
